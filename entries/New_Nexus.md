---
title: New Nexus
description: Groningen-based IT consultancy, target employer in Jan Wilmake's 2026 job search
...
Specifying behavior through Gherkin examples (*Given/When/Then*), co-authored by business, testing, and development stakeholders (the "Three Amigos"). Tools: Cucumber, SpecFlow, Behave.

### Specification by Example (SbE)
Requirements defined through specific concrete examples rather than abstract statements; canonical reference is *Specification by Example* by Gojko Adzic.

### SAFe (Scaled Agile Framework)
Enterprise scaling framework with Agile Release Trains (ARTs), Program Increment (PI) Planning, and a hierarchy of Epics → Features → Stories.
