---
title: The World Is Information
description: Jan Wilmake's philosophical framework connecting information streams, AI agents, and continuous world improvement
category: Concepts
---
...
Jan's version of the framework has three layers:

1. **Information ingestion** — Structured, token-efficient access to external data (GitHub repositories, X posts, research papers, API specifications). This is what the [[Agent_Friendly_Web]] mirror network delivers.
...
In a 2024 blog post, Jan applied the information-processing framework to a direct economic question: what happens to human utility as AI surpasses knowledge workers? He coined the term **Outcomputed** for the point at which a person's domain is fully automatable by machines.
...
Jan explicitly framed this as a path toward beneficial AGI: a system that continuously improves the world by processing information streams, generating optimal actions, and gradually reducing the need for human intervention in low-stakes decisions. The personal and the planetary versions of the framework are structurally identical — only the scope differs.
