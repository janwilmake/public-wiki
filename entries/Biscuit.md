---
title: Biscuit
description: All-in-one business platform by Ives van Hoorne (CodeSandbox) that Jan Wilmake explored in May 2026; relationship dead after 13 days without follow-up
...
- **Data models** — define structured data (Jan created "Blob" and "Post" models)
- **Brand identity** — centralised brand settings
- **Email inbox** — integrated business email
- **Workflows** — automation and process management
- **Preview** — live preview of the project
- **Shared workspaces** — invite co-founders or friends to co-build apps
- **Jobs page** — Biscuit is actively hiring (`biscuit.so/jobs`)
- **Watch page** — showcase of projects built on Biscuit

Biscuit positions itself as a tool for solo builders and founders, combining capabilities that would otherwise require multiple separate SaaS subscriptions.

## Jan Wilmake's Involvement
